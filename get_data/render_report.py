...
def local_to_gbq(local_file_name, table_name, column_names=None):
    """
    This function takes a local csv file, reads the file
    contents, and write the contents to a database.
    """
    ...
    # 2. Write data into database/data warehouse
    print(f'Writing data to table {table_name}...')
